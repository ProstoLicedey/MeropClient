...
const CreateZal = ({Close}) => {
    ...
    const steps = [{
        ...
        title: 'Слайдеры',
        description: 'Начальное и конченое значение слайдера тоже входят в категорию. Например если у вас зал 10 на 10 и вы хотите чтоб 1 ряд бы в отдельной категории необходимо сделать как на фото',
        cover: (<img
            alt="Слайдер зал"
            src={SliderPhoto}
        />),
        ...
        title: 'Важно!',
        description: 'Важно, чтоб каждое место в зале относилось к какой либо категории, иначе зал не добавиться.',
        target: null,
    },];
                        ...
                        onClick={() => {
                            form
                                ...
                                .then((values) => {
                                    ...
                                    if (errorFound) {
                                        notificationFuncion('Ошибка некоторые места не принадлежат не 1 категории, или принадлежит сразу нескольким категориям');
